...
const Units: React.FC = () => {
  ...
  return (
    <section id="unidades" className="py-20 md:py-32 bg-teal-950">
      <div className="container mx-auto px-6">
        <AnimatedSection>
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Nossas Unidades</h2>
        ...
        <AnimatedSection>
          <div className="mb-16">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-8 text-center">Unidade Masculina 1</h3>
            <div className="relative max-w-4xl mx-auto">
              <div className="relative h-96 md:h-[500px] w-full overflow-hidden rounded-lg shadow-xl">
                ...
                <button 
                  onClick={prevImage} 
                  className="absolute top-1/2 left-0 md:-left-16 transform -translate-y-1/2 bg-teal-800/50 hover:bg-amber-500 text-white rounded-full p-3 transition-all duration-300 z-10 active:scale-90"
                ...
                <button 
                  onClick={nextImage} 
                  className="absolute top-1/2 right-0 md:-right-16 transform -translate-y-1/2 bg-teal-800/50 hover:bg-amber-500 text-white rounded-full p-3 transition-all duration-300 z-10 active:scale-90"
        ...
        <div className="grid md:grid-cols-2 gap-16">
            <AnimatedSection>
              <div className="text-center">
                <h3 className="text-2xl md:text-3xl font-bold text-white mb-8">Unidade Feminina</h3>
            ...
            <AnimatedSection>
                <div className="text-center">
                    <h3 className="text-2xl md:text-3xl font-bold text-white mb-8">Unidade Masculina 3</h3>
                    <div className="overflow-hidden rounded-lg shadow-xl group">
                        <img 
                            src={maleUnitImage3} 
