...
const Testimonials: React.FC = () => {
  ...
  return (
    <section id="depoimentos" className="py-20 md:py-32 bg-teal-900">
      <div className="container mx-auto px-6">
        <AnimatedSection>
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Histórias que Inspiram</h2>
          </div>
        </AnimatedSection>
        <AnimatedSection>
          <div className="relative max-w-3xl mx-auto">
            ...
            <div className="relative min-h-[350px] flex items-center justify-center">
              {testimonialsData.map((testimonial, index) => (
                ...
                >
                  {currentIndex === index && (
                    <div className="bg-teal-950 p-8 rounded-lg shadow-lg text-center flex flex-col items-center">
                      ...
                      <p className="text-gray-300 italic mb-6 text-lg min-h-[100px]">"{testimonial.quote}"</p>
            ...
            <button 
              ...
              className="absolute top-1/2 left-0 md:-left-20 transform -translate-y-1/2 bg-teal-800/50 hover:bg-amber-500 text-white rounded-full p-3 transition-all duration-300 z-10 active:scale-90"
            ...
            <button 
              ...
              className="absolute top-1/2 right-0 md:-right-20 transform -translate-y-1/2 bg-teal-800/50 hover:bg-amber-500 text-white rounded-full p-3 transition-all duration-300 z-10 active:scale-90"
